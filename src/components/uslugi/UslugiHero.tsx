      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <div>
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight leading-tight mb-6">
            Od pierwszej idei do gotowej kampanii: wszystkie usługi AI, jakich potrzebuje mała firma
          </h1>
          <p className="text-lg md:text-xl text-gray-700 mb-8">
            Nie trać miesięcy (i tysięcy złotych) na szukanie freelancera "od tekstu", agencji "od wideo" i narzędzia "od grafik". 
            BizMundo.ai dostarcza kompletny pakiet usług, dzięki którym Twoja marka wyróżni się, sprzeda więcej i zrobi to 10× szybciej 
          ...
          <Button size="lg" className="bg-primary hover:bg-primary/90 text-white font-medium px-6 py-6 text-lg">
            Zacznij 14-dniowy darmowy test
          </Button>
        </div>
        ...
        <div className="lg:flex justify-end relative">
          <div className="relative w-full max-w-lg mx-auto lg:mx-0">
            ...
            <img
              ...
              alt="AI dashboard with multiple function icons"

      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <div className="max-w-xl">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight leading-tight mb-6">
            Jedyna subskrypcja AI, której potrzebuje Twój mały biznes
          </h1>
          <p className="text-lg md:text-xl text-gray-700 mb-8">
            Transformuj swój biznes dzięki mocy sztucznej inteligencji. Twórz treści, 
            automatyzuj zadania i podejmuj lepsze decyzje - wszystko w jednym miejscu.
          </p>
          <div className="flex flex-col sm:flex-row gap-4">
            <Button size="lg" className="bg-primary hover:bg-primary-dark text-white font-medium">
              Rozpocznij darmowy okres próbny
            </Button>
            <Button size="lg" variant="outline" className="text-primary border border-primary hover:bg-primary/10">
              Zarezerwuj demo
            </Button>
          </div>
          <p className="text-sm text-gray-500 mt-4">
            Bez karty kredytowej. Darmowy okres próbny na 14 dni.
          </p>
        </div>
        ...
        <div className="lg:flex justify-end relative">
          <div className="relative w-full max-w-lg mx-auto lg:mx-0">
            ...
            <img
              ...
              alt="Small business owner using BizMundo AI dashboard"
